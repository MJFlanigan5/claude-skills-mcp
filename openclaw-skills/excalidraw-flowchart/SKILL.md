...
version: 1.1.0
description: >
  Create Excalidraw flowcharts and diagrams from descriptions.
  USE WHEN: User asks to create a flowchart, diagram, architecture diagram, decision tree, or visualize a process/workflow. Keywords: "draw", "diagram", "flowchart", "visualize", "architecture".
  DON'T USE WHEN: User wants a web UI or dashboard (use frontend-design). Not for text-based documentation or lists. Not for data visualization/charts — this is for structural diagrams only.
  OUTPUTS: .excalidraw files that can be opened in Excalidraw app.
